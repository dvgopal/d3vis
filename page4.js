...
function updateBarChartForYouth(data,chosen) {
    ...
    plot.selectAll('rect')
        ...
        // .delay( function(d,i) { return i * 100; })
        .attr("x", function(d,i) {
             return xScale(d.age) + xScale.bandwidth()/3;
        })
        .attr("width", function(d){
            if(d != 0){
...
function updateBarChartForGender(data,chosen) {
    ...
    var firstDatasetBarChart=[];
    firstDatasetBarChart.push({gender:"Male", value:chosen.Males});
    firstDatasetBarChart.push({gender:"Female",value:chosen.Females});
    ...
    plot.selectAll('rect')
        ...
        // .delay( function(d,i) { return i * 100; })
        .attr("x", function(d,i) {
             return xScale(d.gender) + xScale.bandwidth()/3;
        })
        .attr("width", function(d){
            if(d != 0){
